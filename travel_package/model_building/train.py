...
Xtrain_path = "hf://datasets/vikasksuman/travel-package-dataset/Xtrain.csv"
Xtest_path = "hf://datasets/vikasksuman/travel-package-dataset/Xtest.csv"
ytrain_path = "hf://datasets/vikasksuman/travel-package-dataset/ytrain.csv"
ytest_path = "hf://datasets/vikasksuman/travel-package-dataset/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_travel_package_predict_model_v1.joblib"
    ...
    repo_id = "vikasksuman/travel-package-model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_travel_package_predict_model_v1.joblib",
        path_in_repo="best_travel_package_predict_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
