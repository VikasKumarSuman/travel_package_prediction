...
# Page configuration
st.set_page_config(
    page_title="Wellness Travel Package Prediction",
    page_icon="✈️",
    layout="wide"
)
...
def load_model():
    try:
        model_path = hf_hub_download(
            ...
            filename="best_travel_package_predict_model_v1.joblib"
        )
...
st.title("✈️ Wellness Travel Package Prediction")
st.markdown("""
<style>
    .main-header {
        font-size: 20px;
...
st.markdown("""
This application predicts the likelihood of a customer purchasing the **Wellness Travel Package**
...
<div style='text-align: center; color: #666; padding: 20px;'>
    <p>🏢 Visit with Us - Wellness Travel Package Prediction System</p>
